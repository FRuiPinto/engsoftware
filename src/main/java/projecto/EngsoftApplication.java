...
public class EngsoftApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Tarefa t1 = new Tarefa(LocalDate.of(2020, 9, 20), LocalDate.of(2020, 6, 13), "Software Test Engineer I", c3, p5, 91);
        Tarefa t2 = new Tarefa(LocalDate.of(2020, 8, 17), LocalDate.of(2020, 8, 7), "VP Accounting", c4, p5, 67);
        Tarefa t3 = new Tarefa(LocalDate.of(2020, 9, 3), LocalDate.of(2020, 1, 31), "Research Assistant I", c4, p7, 178);
        Tarefa t4 = new Tarefa(LocalDate.of(2020, 7, 10), LocalDate.of(2020, 2, 19), "VP Quality Control", c3, p7, 81);
        Tarefa t5 = new Tarefa(LocalDate.of(2020, 12, 11), LocalDate.of(2020, 3, 29), "Community Outreach Specialist", c1, p5, 194);
        ...
        Tarefa t10 = new Tarefa(LocalDate.of(2020, 11, 3), LocalDate.of(2020, 6, 14), "Senior Editor", c5, p5, 10);
        Tarefa t11 = new Tarefa(LocalDate.of(2020, 10, 22), LocalDate.of(2020, 4, 2), "Junior Executive", c4, p4, 114);
        ...
        Tarefa t14 = new Tarefa(LocalDate.of(2020, 7, 1), LocalDate.of(2020, 4, 26), "Automation Specialist I", c1, p5, 17);
        Tarefa t15 = new Tarefa(LocalDate.of(2020, 8, 23), LocalDate.of(2020, 10, 18), "Environmental Tech", c4, p7, 68);
        Tarefa t16 = new Tarefa(LocalDate.of(2020, 9, 28), LocalDate.of(2020, 7, 19), "Biostatistician IV", c1, p5, 85);
        ...
        Tarefa t19 = new Tarefa(LocalDate.of(2020, 3, 27), LocalDate.of(2020, 3, 13), "Structural Engineer", c3, p5, 63);
        Tarefa t20 = new Tarefa(LocalDate.of(2020, 8, 24), LocalDate.of(2020, 9, 9), "Financial Analyst", c5, p3, 155);
        Tarefa t21 = new Tarefa(LocalDate.of(2020, 11, 4), LocalDate.of(2020, 6, 22), "Research Nurse", c4, p6, 55);
        Tarefa t22 = new Tarefa(LocalDate.of(2020, 1, 25), LocalDate.of(2020, 8, 26), "Operator", c2, p4, 39);
        Tarefa t23 = new Tarefa(LocalDate.of(2020, 9, 12), LocalDate.of(2020, 7, 17), "Human Resources Manager", c2, p2, 84);
        Tarefa t24 = new Tarefa(LocalDate.of(2020, 3, 16), LocalDate.of(2020, 2, 21), "Actuary", c1, p1, 162);
        Tarefa t25 = new Tarefa(LocalDate.of(2020, 3, 11), LocalDate.of(2020, 7, 1), "Marketing Assistant", c1, p5, 196);
        Tarefa t26 = new Tarefa(LocalDate.of(2020, 12, 19), LocalDate.of(2020, 10, 20), "Environmental Specialist", c1, p6, 173);
        ...
        Tarefa t29 = new Tarefa(LocalDate.of(2020, 6, 4), LocalDate.of(2020, 3, 22), "Occupational Therapist", c3, p5, 9);
        Tarefa t30 = new Tarefa(LocalDate.of(2020, 3, 22), LocalDate.of(2020, 6, 14), "Account Representative I", c4, p5, 91);
        Tarefa t31 = new Tarefa(LocalDate.of(2020, 10, 31), LocalDate.of(2020, 6, 28), "Statistician IV", c3, p7, 14);
        Tarefa t32 = new Tarefa(LocalDate.of(2020, 3, 3), LocalDate.of(2020, 2, 19), "Nuclear Power Engineer", c4, p2, 89);
        Tarefa t33 = new Tarefa(LocalDate.of(2020, 1, 20), LocalDate.of(2020, 11, 1), "Design Engineer", c3, p7, 160);
        Tarefa t34 = new Tarefa(LocalDate.of(2020, 12, 7), LocalDate.of(2020, 10, 21), "Civil Engineer", c5, p1, 153);
        Tarefa t35 = new Tarefa(LocalDate.of(2020, 12, 1), LocalDate.of(2020, 10, 20), "VP Accounting", c4, p2, 11);
        Tarefa t36 = new Tarefa(LocalDate.of(2020, 1, 14), LocalDate.of(2020, 12, 27), "Research Nurse", c1, p6, 44);
        Tarefa t37 = new Tarefa(LocalDate.of(2020, 5, 5), LocalDate.of(2020, 4, 15), "Account Coordinator", c3, p6, 88);
        ...
        Tarefa t44 = new Tarefa(LocalDate.of(2020, 8, 7), LocalDate.of(2020, 4, 22), "Web Designer II", c2, p5, 30);
        Tarefa t45 = new Tarefa(LocalDate.of(2020, 5, 30), LocalDate.of(2020, 5, 10), "Community Outreach Specialist", c1, p4, 174);
        ...
        Tarefa t48 = new Tarefa(LocalDate.of(2020, 11, 19), LocalDate.of(2020, 3, 31), "Research Nurse", c2, p1, 3);
